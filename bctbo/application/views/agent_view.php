...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
					...
					<div class="col-12">
						...
						<div class="card">
							...
							<div class="card-header">
								...
								<form action="<?php echo site_url('agent/search');?>" id="agent-form" name="agent-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
											...
											<div class="row mb-2">
												...
												<div class="col-8">
													...
													<select class="form-control form-control-sm select2bs4 col-12" id="status" name="status">
														...
														<option value="<?php echo STATUS_PENDING;?>" <?php echo (isset($data_search['status']) && ($data_search['status'] == STATUS_PENDING) ? 'selected="selected"' : '""');?>><?php echo $this->lang->line('label_pending');?></option>
							...
							<?php echo form_open('export/agent_export_excel', 'class="export" id="export_form"');?>
							...
							<div class="card-body" style="display:none;">
								...
								<table id="agent-table" class="table table-striped table-bordered table-hover">
									...
									<thead>
										...
										<tr>
											...
											<th width="100"><?php echo $this->lang->line('label_fullname');?></th>

											<th width="100"><?php echo $this->lang->line('label_mobile');?></th>

											<th width="100"><?php echo $this->lang->line('label_bank_name');?></th>

											<th width="100"><?php echo $this->lang->line('title_bank_account');?></th>
	...
	<script type="text/javascript">
		...
		function exportData(){
			...
			$.ajax({url: '<?php echo base_url("export/agent_export_excel_check");?>',
		...
		function updateData(id) {
			...
			layer.open({
				...
				title: '<?php echo $this->lang->line('title_agent_approve');?>',

				content: '<?php echo base_url('agent/edit/');?>' + id
		...
		function loadTable(){
			...
			$('#agent-table').DataTable({
				...
				"ajax": {
					...
					"url": "<?php echo site_url('agent/listing');?>",
