							...
							<?php echo form_open('game/sub_game_update', array('id' => 'sub_game-form', 'name' => 'sub_game-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									...
									<div class="form-group row mt-3">
										...
										<div class="col-7">
											<a href="<?php echo SUBGAME_SOURCE_PATH . $game_picture_en;?>" target="_blank"><img src="<?php echo SUBGAME_SOURCE_PATH .sub_game_image_location($game_type_code)."/".strtolower($game_provider_code)."/en/". $game_picture_en;?>" width="200" border="0" /></a>
										</div>
									</div>
									<?php endif;?>
									<div class="form-group row">
									...
									<div class="form-group row mt-3">
										<label class="col-5 col-form-label">&nbsp;</label>
										<div class="col-7">
											<a href="<?php echo SUBGAME_SOURCE_PATH . $game_picture_chs;?>" target="_blank"><img src="<?php echo SUBGAME_SOURCE_PATH .sub_game_image_location($game_type_code)."/".strtolower($game_provider_code)."/cn/". $game_picture_chs;?>" width="200" border="0" /></a>
										</div>
									</div>
									<?php endif;?>
									<div class="form-group row">
									...
									<div class="form-group row mt-3">
										<label class="col-5 col-form-label">&nbsp;</label>
										<div class="col-7">
											<a href="<?php echo SUBGAME_SOURCE_PATH . $game_picture_cht;?>" target="_blank"><img src="<?php echo SUBGAME_SOURCE_PATH .sub_game_image_location($game_type_code)."/".strtolower($game_provider_code)."/zh/". $game_picture_cht;?>" width="200" border="0" /></a>
										</div>
									</div>
									<?php endif;?>
									<div class="form-group row">
