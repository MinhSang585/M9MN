				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							...
							<?php echo form_open('player/kick', array('id' => 'player-form', 'name' => 'player-form', 'class' => 'form-horizontal'));?>
						...
						$.ajax({url: form.attr('action'),
							...
							success: function (data) {
								...
								if(json.status == '<?php echo EXIT_SUCCESS;?>') {
									...
									parent.$('#uc9_' + json.response.id).html(json.response.remark);
			...
			form.validate({
				...
				messages: {
					...
					remark: {
						...
						required: "<?php echo $this->lang->line('error_invalid_remark');?>",
					},
				},
