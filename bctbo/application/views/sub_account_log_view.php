					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<form action="<?php echo site_url('logs/sub_account_log_search');?>" id="log-form" name="log-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
	...
	<script type="text/javascript">
		...
		function loadTotal(){
			$('#log-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('logs/sub_account_log_listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function displayContent(id){
			layer.open({
				...
				content: '<?php echo base_url('logs/sub_user_content/');?>' + id
			});
		}
	</script>	
</body>
