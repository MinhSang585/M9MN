				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							...
							<?php echo form_open('role/submit', array('id' => 'user_role-form', 'name' => 'user_role-form', 'class' => 'form-horizontal'));?>
								...
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-7">
											...
											<input type="text" class="form-control" id="role_name" name="role_name" value="" maxlength="16">
									...
									<div class="form-group row" style="display:none">
										...
										<label for="level" class="col-5 col-form-label"><?php echo $this->lang->line('label_level');?></label>
										...
										<div class="col-7">
											...
											<select class="form-control select2bs4" id="level" name="level">
												...
												<?php
													if(!empty($level_list)){
														foreach ($level_list as $role_level){
															echo '<option value="' . $role_level . '">' . $role_level . '</option>';
														}
													}
												?>
											</select>
									...
									<div class="form-group row">
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_HOME;?> checkbox_option" type="<?php echo (($permissions[PERMISSION_HOME]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_HOME;?>" name="permissions[]" value="<?php echo PERMISSION_HOME;?>" <?php echo (($permissions[PERMISSION_HOME]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_HOME]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_SUB_ACCOUNT_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_SUB_ACCOUNT_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SUB_ACCOUNT_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_SUB_ACCOUNT_VIEW;?>" <?php echo (($permissions[PERMISSION_SUB_ACCOUNT_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_SUB_ACCOUNT_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CHANGE_PASSWORD;?> checkbox_option sub_permissions_<?php echo PERMISSION_SUB_ACCOUNT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SUB_ACCOUNT_VIEW;?>_<?php echo PERMISSION_CHANGE_PASSWORD;?>" name="permissions[]" value="<?php echo PERMISSION_CHANGE_PASSWORD;?>" <?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PERMISSION_SETUP;?> checkbox_option sub_permissions_<?php echo PERMISSION_SUB_ACCOUNT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PERMISSION_SETUP]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SUB_ACCOUNT_VIEW;?>_<?php echo PERMISSION_PERMISSION_SETUP;?>" name="permissions[]" value="<?php echo PERMISSION_PERMISSION_SETUP;?>" <?php echo (($permissions[PERMISSION_PERMISSION_SETUP]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PERMISSION_SETUP]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_USER_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_USER_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_USER_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_USER_VIEW;?>" <?php echo (($permissions[PERMISSION_USER_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_USER_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_USER_ADD;?> checkbox_option sub_permissions_<?php echo PERMISSION_USER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_USER_ADD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_USER_VIEW;?>_<?php echo PERMISSION_USER_ADD;?>" name="permissions[]" value="<?php echo PERMISSION_USER_ADD;?>" <?php echo (($permissions[PERMISSION_USER_ADD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_USER_ADD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PERMISSION_SETUP;?> checkbox_option sub_permissions_<?php echo PERMISSION_USER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PERMISSION_SETUP]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_USER_VIEW;?>_<?php echo PERMISSION_PERMISSION_SETUP;?>" name="permissions[]" value="<?php echo PERMISSION_PERMISSION_SETUP;?>" <?php echo (($permissions[PERMISSION_PERMISSION_SETUP]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PERMISSION_SETUP]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CHANGE_PASSWORD;?> checkbox_option sub_permissions_<?php echo PERMISSION_USER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_USER_VIEW;?>_<?php echo PERMISSION_CHANGE_PASSWORD;?>" name="permissions[]" value="<?php echo PERMISSION_CHANGE_PASSWORD;?>" <?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_DEPOSIT_POINT_TO_DOWNLINE;?> checkbox_option sub_permissions_<?php echo PERMISSION_USER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_DEPOSIT_POINT_TO_DOWNLINE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_USER_VIEW;?>_<?php echo PERMISSION_DEPOSIT_POINT_TO_DOWNLINE;?>" name="permissions[]" value="<?php echo PERMISSION_DEPOSIT_POINT_TO_DOWNLINE;?>" <?php echo (($permissions[PERMISSION_DEPOSIT_POINT_TO_DOWNLINE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_DEPOSIT_POINT_TO_DOWNLINE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_VIEW_PLAYER_TURNOVER;?> checkbox_option main_permissions sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_VIEW_PLAYER_TURNOVER]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_VIEW_PLAYER_TURNOVER;?>" name="permissions[]" value="<?php echo PERMISSION_VIEW_PLAYER_TURNOVER;?>" <?php echo (($permissions[PERMISSION_VIEW_PLAYER_TURNOVER]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_VIEW_PLAYER_TURNOVER]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 60px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_VIEW_PLAYER_TURNOVER;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?> sub_permissions_<?php echo PERMISSION_VIEW_PLAYER_TURNOVER;?>" type="<?php echo (($permissions[PERMISSION_ADJUST_PLAYER_TURNOVER]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_VIEW_PLAYER_TURNOVER;?>_<?php echo PERMISSION_ADJUST_PLAYER_TURNOVER;?>" name="permissions[]" value="<?php echo PERMISSION_ADJUST_PLAYER_TURNOVER;?>" <?php echo (($permissions[PERMISSION_ADJUST_PLAYER_TURNOVER]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_ADJUST_PLAYER_TURNOVER]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_PROMOTION_TURNOVER_CALCULATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_TURNOVER_CALCULATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_PLAYER_PROMOTION_TURNOVER_CALCULATE;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_PROMOTION_TURNOVER_CALCULATE;?>" <?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_TURNOVER_CALCULATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_TURNOVER_CALCULATE]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_VIEW_PLAYER_CONTACT_V2;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_VIEW_PLAYER_CONTACT_V2]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_VIEW_PLAYER_CONTACT_V2;?>" name="permissions[]" value="<?php echo PERMISSION_VIEW_PLAYER_CONTACT_V2;?>" <?php echo (($permissions[PERMISSION_VIEW_PLAYER_CONTACT_V2]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_VIEW_PLAYER_CONTACT_V2]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 60px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_VIEW_PLAYER_WALLET;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?> sub_permissions_<?php echo PERMISSION_VIEW_PLAYER_WALLET;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_GAME_TRANSFER]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_VIEW_PLAYER_WALLET;?>_<?php echo PERMISSION_PLAYER_GAME_TRANSFER;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_GAME_TRANSFER;?>" <?php echo (($permissions[PERMISSION_PLAYER_GAME_TRANSFER]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_GAME_TRANSFER]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 60px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_VIEW_PLAYER_WALLET;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?> sub_permissions_<?php echo PERMISSION_VIEW_PLAYER_WALLET;?>" type="<?php echo (($permissions[PERMISSION_KICK_PLAYER]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_VIEW_PLAYER_WALLET;?>_<?php echo PERMISSION_KICK_PLAYER;?>" name="permissions[]" value="<?php echo PERMISSION_KICK_PLAYER;?>" <?php echo (($permissions[PERMISSION_KICK_PLAYER]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_KICK_PLAYER]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CHANGE_PASSWORD;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_CHANGE_PASSWORD;?>" name="permissions[]" value="<?php echo PERMISSION_CHANGE_PASSWORD;?>" <?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_DEPOSIT_POINT_TO_DOWNLINE;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_DEPOSIT_POINT_TO_DOWNLINE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_DEPOSIT_POINT_TO_DOWNLINE;?>" name="permissions[]" value="<?php echo PERMISSION_DEPOSIT_POINT_TO_DOWNLINE;?>" <?php echo (($permissions[PERMISSION_DEPOSIT_POINT_TO_DOWNLINE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_DEPOSIT_POINT_TO_DOWNLINE]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_POINT_ADJUSTMENT;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_POINT_ADJUSTMENT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_PLAYER_POINT_ADJUSTMENT;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_POINT_ADJUSTMENT;?>" <?php echo (($permissions[PERMISSION_PLAYER_POINT_ADJUSTMENT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_POINT_ADJUSTMENT]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_DEPOSIT_ADD;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_DEPOSIT_ADD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_DEPOSIT_ADD;?>" name="permissions[]" value="<?php echo PERMISSION_DEPOSIT_ADD;?>" <?php echo (($permissions[PERMISSION_DEPOSIT_ADD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_DEPOSIT_ADD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_DEPOSIT_APPROVE_ADD;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_DEPOSIT_APPROVE_ADD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_DEPOSIT_APPROVE_ADD;?>" name="permissions[]" value="<?php echo PERMISSION_DEPOSIT_APPROVE_ADD;?>" <?php echo (($permissions[PERMISSION_DEPOSIT_APPROVE_ADD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_DEPOSIT_APPROVE_ADD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_REWARD_DEDUCT;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_REWARD_DEDUCT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_REWARD_DEDUCT;?>" name="permissions[]" value="<?php echo PERMISSION_REWARD_DEDUCT;?>" <?php echo (($permissions[PERMISSION_REWARD_DEDUCT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_REWARD_DEDUCT]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_DAILY_REPORT;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_DAILY_REPORT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_PLAYER_DAILY_REPORT;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_DAILY_REPORT;?>" <?php echo (($permissions[PERMISSION_PLAYER_DAILY_REPORT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_DAILY_REPORT]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BANK_PLAYER_USER_VIEW;?> checkbox_option main_permissions sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BANK_PLAYER_USER_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_BANK_PLAYER_USER_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_BANK_PLAYER_USER_VIEW;?>" <?php echo (($permissions[PERMISSION_BANK_PLAYER_USER_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BANK_PLAYER_USER_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_WHITELIST_ADD;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_WHITELIST_ADD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_WHITELIST_ADD;?>" name="permissions[]" value="<?php echo PERMISSION_WHITELIST_ADD;?>" <?php echo (($permissions[PERMISSION_WHITELIST_ADD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_WHITELIST_ADD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_KICK_PLAYER;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_KICK_PLAYER]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_KICK_PLAYER;?>" name="permissions[]" value="<?php echo PERMISSION_KICK_PLAYER;?>" <?php echo (($permissions[PERMISSION_KICK_PLAYER]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_KICK_PLAYER]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?> checkbox_option main_permissions sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?>" <?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_REPORT_EXPORT_EXCEL;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_PLAYER_REPORT_EXPORT_EXCEL;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_REPORT_EXPORT_EXCEL;?>" <?php echo (($permissions[PERMISSION_PLAYER_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_REPORT_EXPORT_EXCEL]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_TAG_MODIFY;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_TAG_MODIFY]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_TAG_MODIFY;?>" name="permissions[]" value="<?php echo PERMISSION_TAG_MODIFY;?>" <?php echo (($permissions[PERMISSION_TAG_MODIFY]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_TAG_MODIFY]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_TAG_PLAYER_MODIFY;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_TAG_PLAYER_MODIFY]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_TAG_PLAYER_MODIFY;?>" name="permissions[]" value="<?php echo PERMISSION_TAG_PLAYER_MODIFY;?>" <?php echo (($permissions[PERMISSION_TAG_PLAYER_MODIFY]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_TAG_PLAYER_MODIFY]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_MOBILE;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_MOBILE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_PLAYER_MOBILE;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_MOBILE;?>" <?php echo (($permissions[PERMISSION_PLAYER_MOBILE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_MOBILE]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_LINE_ID;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_LINE_ID]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_PLAYER_LINE_ID;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_LINE_ID;?>" <?php echo (($permissions[PERMISSION_PLAYER_LINE_ID]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_LINE_ID]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_ACCOUNT_NAME;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_ACCOUNT_NAME]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_VIEW;?>_<?php echo PERMISSION_PLAYER_ACCOUNT_NAME;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_ACCOUNT_NAME;?>" <?php echo (($permissions[PERMISSION_PLAYER_ACCOUNT_NAME]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_ACCOUNT_NAME]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CHANGE_PASSWORD;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_AGENT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_AGENT_VIEW;?>_<?php echo PERMISSION_CHANGE_PASSWORD;?>" name="permissions[]" value="<?php echo PERMISSION_CHANGE_PASSWORD;?>" <?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CHANGE_PASSWORD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_TRANSACTION_REPORT;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_AGENT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_TRANSACTION_REPORT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_AGENT_VIEW;?>_<?php echo PERMISSION_TRANSACTION_REPORT;?>" name="permissions[]" value="<?php echo PERMISSION_TRANSACTION_REPORT;?>" <?php echo (($permissions[PERMISSION_TRANSACTION_REPORT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_TRANSACTION_REPORT]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BANK_AGENT_PLAYER_USER_VIEW;?> checkbox_option sub_permissions_<?php echo PERMISSION_PLAYER_AGENT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BANK_AGENT_PLAYER_USER_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PLAYER_AGENT_VIEW;?>_<?php echo PERMISSION_BANK_AGENT_PLAYER_USER_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_BANK_AGENT_PLAYER_USER_VIEW;?>" <?php echo (($permissions[PERMISSION_BANK_AGENT_PLAYER_USER_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BANK_AGENT_PLAYER_USER_VIEW]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?> checkbox_option main_permissions sub_permissions_<?php echo PERMISSION_DEPOSIT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_DEPOSIT_VIEW;?>_<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?>" <?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 60px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?> checkbox_option sub_permissions_<?php echo PERMISSION_DEPOSIT_VIEW;?> sub_permissions_<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_ADD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_DEPOSIT_VIEW;?>_<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?>_<?php echo PERMISSION_PLAYER_PROMOTION_ADD;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_PROMOTION_ADD;?>" <?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_ADD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_ADD]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_HOME;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_WITHDRAWAL_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_WITHDRAWAL_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_WITHDRAWAL_VIEW;?>" <?php echo (($permissions[PERMISSION_WITHDRAWAL_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_WITHDRAWAL_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_WITHDRAWAL_VIEW_ALL;?> checkbox_option sub_permissions_<?php echo PERMISSION_WITHDRAWAL_VIEW;?>" type="<?php echo (($permissions[PERMISSION_WITHDRAWAL_VIEW_ALL]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_WITHDRAWAL_VIEW;?>_<?php echo PERMISSION_WITHDRAWAL_VIEW_ALL;?>" name="permissions[]" value="<?php echo PERMISSION_WITHDRAWAL_VIEW_ALL;?>" <?php echo (($permissions[PERMISSION_WITHDRAWAL_VIEW_ALL]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_WITHDRAWAL_VIEW_ALL]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?> checkbox_option main_permissions sub_permissions_<?php echo PERMISSION_WITHDRAWAL_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_WITHDRAWAL_VIEW;?>_<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_PROMOTION_VIEW;?>" <?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_PROMOTION_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_DAILY_REPORT;?> checkbox_option sub_permissions_<?php echo PERMISSION_WITHDRAWAL_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_DAILY_REPORT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_WITHDRAWAL_VIEW;?>_<?php echo PERMISSION_PLAYER_DAILY_REPORT;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_DAILY_REPORT;?>" <?php echo (($permissions[PERMISSION_PLAYER_DAILY_REPORT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_DAILY_REPORT]['upline']) ? 'checked' : '');?>>
										...
										<?php if ($permissions[PERMISSION_KYC_VIEW]['upline'] == TRUE) : ?>
											<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
												<div class="form-group row">
													<?php if ($permissions[PERMISSION_KYC_VIEW]['upline'] == TRUE) : ?>
														<div class="form-group clearfix col-12">
															<div class="custom-control custom-checkbox d-inline">
																<input class="custom-control-input permission_<?php echo PERMISSION_KYC_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_KYC_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_KYC_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_KYC_VIEW; ?>" <?php echo (($permissions[PERMISSION_KYC_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_KYC_VIEW]['upline']) ? 'checked' : ''); ?>>

																<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_KYC_VIEW; ?>">

																	<?php echo $this->lang->line('label_kyc'); ?> &nbsp;
													...
													<?php if ($permissions[PERMISSION_KYC_ADD]['upline'] == TRUE) : ?>

														<div class="form-group clearfix col-12" style="padding-left: 30px;">

															├ <div class="custom-control custom-checkbox d-inline">

																<input class="custom-control-input permission_<?php echo PERMISSION_KYC_ADD; ?> checkbox_option sub_permissions_<?php echo PERMISSION_KYC_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_KYC_ADD]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_KYC_VIEW; ?>_<?php echo PERMISSION_KYC_ADD; ?>" name="permissions[]" value="<?php echo PERMISSION_KYC_ADD; ?>" <?php echo (($permissions[PERMISSION_KYC_ADD]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_KYC_ADD]['upline']) ? 'checked' : ''); ?>>

																<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_KYC_VIEW; ?>_<?php echo PERMISSION_KYC_ADD; ?>">
													...
													<?php if ($permissions[PERMISSION_KYC_UPDATE]['upline'] == TRUE) : ?>
														<div class="form-group clearfix col-12" style="padding-left: 30px;">
															├ <div class="custom-control custom-checkbox d-inline">

																<input class="custom-control-input permission_<?php echo PERMISSION_KYC_UPDATE; ?> checkbox_option sub_permissions_<?php echo PERMISSION_KYC_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_KYC_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_KYC_VIEW; ?>_<?php echo PERMISSION_KYC_UPDATE; ?>" name="permissions[]" value="<?php echo PERMISSION_KYC_UPDATE; ?>" <?php echo (($permissions[PERMISSION_KYC_UPDATE]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_KYC_UPDATE]['upline']) ? 'checked' : ''); ?>>

																<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_KYC_VIEW; ?>_<?php echo PERMISSION_KYC_UPDATE; ?>">
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BANK_PLAYER_USER_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_BANK_PLAYER_USER_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BANK_PLAYER_USER_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_BANK_PLAYER_USER_VIEW;?>" <?php echo (($permissions[PERMISSION_BANK_PLAYER_USER_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BANK_PLAYER_USER_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_BANK_WITHDRAWAL_COUNT_UDPATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_BANK_PLAYER_USER_VIEW;?> sub_permissions_<?php echo PERMISSION_PLAYER_BANK_WITHDRAWAL_COUNT_UDPATE;?>" type="<?php echo (($permissions[PERMISSION_PLAYER_BANK_WITHDRAWAL_COUNT_UDPATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BANK_PLAYER_USER_VIEW;?>_<?php echo PERMISSION_PLAYER_BANK_WITHDRAWAL_COUNT_UDPATE;?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_BANK_WITHDRAWAL_COUNT_UDPATE;?>" <?php echo (($permissions[PERMISSION_PLAYER_BANK_WITHDRAWAL_COUNT_UDPATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PLAYER_BANK_WITHDRAWAL_COUNT_UDPATE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>" name="permissions[]" value="<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>" <?php echo (($permissions[PERMISSION_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_REPORT_EXPORT_EXCEL]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_WIN_LOSS_REPORT;?> checkbox_option sub_permissions_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>" type="<?php echo (($permissions[PERMISSION_WIN_LOSS_REPORT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>_<?php echo PERMISSION_WIN_LOSS_REPORT;?>" name="permissions[]" value="<?php echo PERMISSION_WIN_LOSS_REPORT;?>" <?php echo (($permissions[PERMISSION_WIN_LOSS_REPORT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_WIN_LOSS_REPORT]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 60px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_WIN_LOSS_REPORT_EXPORT_EXCEL;?> main_permissions checkbox_option sub_permissions_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?> sub_permissions_<?php echo PERMISSION_WIN_LOSS_REPORT;?>" type="<?php echo (($permissions[PERMISSION_WIN_LOSS_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>_<?php echo PERMISSION_WIN_LOSS_REPORT;?>_<?php echo PERMISSION_WIN_LOSS_REPORT_EXPORT_EXCEL;?>" name="permissions[]" value="<?php echo PERMISSION_WIN_LOSS_REPORT_EXPORT_EXCEL;?>" <?php echo (($permissions[PERMISSION_WIN_LOSS_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_WIN_LOSS_REPORT_EXPORT_EXCEL]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_REGISTER_DEPOSIT_RATE_YEARLY_REPORT;?> checkbox_option sub_permissions_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>" type="<?php echo (($permissions[PERMISSION_REGISTER_DEPOSIT_RATE_YEARLY_REPORT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>_<?php echo PERMISSION_REGISTER_DEPOSIT_RATE_YEARLY_REPORT;?>" name="permissions[]" value="<?php echo PERMISSION_REGISTER_DEPOSIT_RATE_YEARLY_REPORT;?>" <?php echo (($permissions[PERMISSION_REGISTER_DEPOSIT_RATE_YEARLY_REPORT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_REGISTER_DEPOSIT_RATE_YEARLY_REPORT]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_TRANSACTION_REPORT;?> checkbox_option sub_permissions_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>" type="<?php echo (($permissions[PERMISSION_TRANSACTION_REPORT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>_<?php echo PERMISSION_TRANSACTION_REPORT;?>" name="permissions[]" value="<?php echo PERMISSION_TRANSACTION_REPORT;?>" <?php echo (($permissions[PERMISSION_TRANSACTION_REPORT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_TRANSACTION_REPORT]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_REWARD_TRANSACTION_REPORT;?> checkbox_option sub_permissions_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>" type="<?php echo (($permissions[PERMISSION_REWARD_TRANSACTION_REPORT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>_<?php echo PERMISSION_REWARD_TRANSACTION_REPORT;?>" name="permissions[]" value="<?php echo PERMISSION_REWARD_TRANSACTION_REPORT;?>" <?php echo (($permissions[PERMISSION_REWARD_TRANSACTION_REPORT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_REWARD_TRANSACTION_REPORT]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 60px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_WALLET_REPORT_EXPORT_EXCEL;?> main_permissions checkbox_option sub_permissions_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?> sub_permissions_<?php echo PERMISSION_WALLET_TRANSACTION_REPORT;?>" type="<?php echo (($permissions[PERMISSION_WALLET_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>_<?php echo PERMISSION_WALLET_TRANSACTION_REPORT;?>_<?php echo PERMISSION_WALLET_REPORT_EXPORT_EXCEL;?>" name="permissions[]" value="<?php echo PERMISSION_WALLET_REPORT_EXPORT_EXCEL;?>" <?php echo (($permissions[PERMISSION_WALLET_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_WALLET_REPORT_EXPORT_EXCEL]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_TAG_PROCESS_REPORT;?> checkbox_option sub_permissions_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>" type="<?php echo (($permissions[PERMISSION_TAG_PROCESS_REPORT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL;?>_<?php echo PERMISSION_TAG_PROCESS_REPORT;?>" name="permissions[]" value="<?php echo PERMISSION_TAG_PROCESS_REPORT;?>" <?php echo (($permissions[PERMISSION_TAG_PROCESS_REPORT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_TAG_PROCESS_REPORT]['upline']) ? 'checked' : '');?>>
												...
												<!-- Start Bank report -->
												<?php if ($permissions[PERMISSION_BANK_REPORT_VIEW]['upline'] == TRUE) : ?>

													<div class="form-group clearfix col-12" style="padding-left: 30px;">

														├ <div class="custom-control custom-checkbox d-inline">

															<input class="custom-control-input permission_<?php echo PERMISSION_BANK_REPORT_VIEW; ?> checkbox_option sub_permissions_<?php echo PERMISSION_REPORT_EXPORT_EXCEL; ?>" type="<?php echo (($permissions[PERMISSION_BANK_REPORT_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL; ?>_<?php echo PERMISSION_BANK_REPORT_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_BANK_REPORT_VIEW; ?>" <?php echo (($permissions[PERMISSION_BANK_REPORT_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_BANK_REPORT_VIEW]['upline']) ? 'checked' : ''); ?>>

															<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL; ?>_<?php echo PERMISSION_BANK_REPORT_VIEW; ?>">

																<?php echo $this->lang->line('title_bank_report'); ?> &nbsp;
												...
												<?php if ($permissions[PERMISSION_BANK_REPORT_EXPORT_EXCEL]['upline'] == TRUE) : ?>

													<div class="form-group clearfix col-12" style="padding-left: 60px;">

														├ <div class="custom-control custom-checkbox d-inline">

															<input class="custom-control-input permission_<?php echo PERMISSION_BANK_REPORT_EXPORT_EXCEL; ?> main_permissions checkbox_option sub_permissions_<?php echo PERMISSION_REPORT_EXPORT_EXCEL; ?> sub_permissions_<?php echo PERMISSION_BANK_REPORT_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_BANK_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL; ?>_<?php echo PERMISSION_BANK_REPORT_VIEW; ?>_<?php echo PERMISSION_BANK_REPORT_EXPORT_EXCEL; ?>" name="permissions[]" value="<?php echo PERMISSION_BANK_REPORT_EXPORT_EXCEL; ?>" <?php echo (($permissions[PERMISSION_BANK_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_BANK_REPORT_EXPORT_EXCEL]['upline']) ? 'checked' : ''); ?>>

															<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_REPORT_EXPORT_EXCEL; ?>_<?php echo PERMISSION_BANK_REPORT_VIEW; ?>_<?php echo PERMISSION_BANK_REPORT_EXPORT_EXCEL; ?>">
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_REWARD_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_REWARD_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_REWARD_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_REWARD_VIEW;?>" <?php echo (($permissions[PERMISSION_REWARD_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_REWARD_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_REWARD_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_REWARD_VIEW;?>" type="<?php echo (($permissions[PERMISSION_REWARD_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_REWARD_VIEW;?>_<?php echo PERMISSION_REWARD_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_REWARD_UPDATE;?>" <?php echo (($permissions[PERMISSION_REWARD_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_REWARD_UPDATE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_WALLET_TRANSACTION_PENDING_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_WALLET_TRANSACTION_PENDING_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_WALLET_TRANSACTION_PENDING_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_WALLET_TRANSACTION_PENDING_VIEW;?>" <?php echo (($permissions[PERMISSION_WALLET_TRANSACTION_PENDING_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_WALLET_TRANSACTION_PENDING_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_WALLET_TRANSACTION_PENDING_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_WALLET_TRANSACTION_PENDING_VIEW;?>" type="<?php echo (($permissions[PERMISSION_WALLET_TRANSACTION_PENDING_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_WALLET_TRANSACTION_PENDING_VIEW;?>_<?php echo PERMISSION_WALLET_TRANSACTION_PENDING_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_WALLET_TRANSACTION_PENDING_UPDATE;?>" <?php echo (($permissions[PERMISSION_WALLET_TRANSACTION_PENDING_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_WALLET_TRANSACTION_PENDING_UPDATE]['upline']) ? 'checked' : '');?>>
										...
										<?php if($permissions[PERMISSION_AGENT_VIEW]['upline'] == TRUE):?>
											<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
												<div class="form-group row">
													<?php if($permissions[PERMISSION_AGENT_VIEW]['upline'] == TRUE):?>
														<div class="form-group clearfix col-12">
															<div class="custom-control custom-checkbox d-inline">
																<input class="custom-control-input permission_<?php echo PERMISSION_AGENT_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_AGENT_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_AGENT_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_AGENT_VIEW;?>" <?php echo (($permissions[PERMISSION_AGENT_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_AGENT_VIEW]['upline']) ? 'checked' : '');?>>

																<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_AGENT_VIEW;?>">
													...
													<?php if($permissions[PERMISSION_AGENT_UPDATE]['upline'] == TRUE):?>
														<div class="form-group clearfix col-12" style="padding-left: 30px;">
															├ <div class="custom-control custom-checkbox d-inline">

																<input class="custom-control-input permission_<?php echo PERMISSION_AGENT_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_AGENT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_AGENT_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_AGENT_VIEW;?>_<?php echo PERMISSION_AGENT_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_AGENT_UPDATE;?>" <?php echo (($permissions[PERMISSION_AGENT_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_AGENT_UPDATE]['upline']) ? 'checked' : '');?>>

																<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_AGENT_VIEW;?>_<?php echo PERMISSION_AGENT_UPDATE;?>">
													...
													<?php if($permissions[PERMISSION_AGENT_REPORT_EXPORT_EXCEL]['upline'] == TRUE):?>
														<div class="form-group clearfix col-12" style="padding-left: 30px;">
															├ <div class="custom-control custom-checkbox d-inline">

																<input class="custom-control-input permission_<?php echo PERMISSION_AGENT_REPORT_EXPORT_EXCEL;?> checkbox_option sub_permissions_<?php echo PERMISSION_AGENT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_AGENT_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_AGENT_VIEW;?>_<?php echo PERMISSION_AGENT_REPORT_EXPORT_EXCEL;?>" name="permissions[]" value="<?php echo PERMISSION_AGENT_REPORT_EXPORT_EXCEL;?>" <?php echo (($permissions[PERMISSION_AGENT_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_AGENT_REPORT_EXPORT_EXCEL]['upline']) ? 'checked' : '');?>>

																<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_AGENT_VIEW;?>_<?php echo PERMISSION_AGENT_REPORT_EXPORT_EXCEL;?>">
										...
										<?php if($permissions[PERMISSION_VIP_REWARD_VIEW]['upline'] == TRUE):?>
											<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
												<div class="form-group row">
													<?php if($permissions[PERMISSION_VIP_REWARD_VIEW]['upline'] == TRUE):?>
														<div class="form-group clearfix col-12">
															<div class="custom-control custom-checkbox d-inline">
																<input class="custom-control-input permission_<?php echo PERMISSION_VIP_REWARD_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_VIP_REWARD_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_VIP_REWARD_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_VIP_REWARD_VIEW;?>" <?php echo (($permissions[PERMISSION_VIP_REWARD_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_VIP_REWARD_VIEW]['upline']) ? 'checked' : '');?>>

																<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_VIP_REWARD_VIEW;?>">

																<?php echo $this->lang->line('label_vip_reward');?> &nbsp; 
													...
													<?php if($permissions[PERMISSION_VIP_REWARD_UPDATE]['upline'] == TRUE):?>
														<div class="form-group clearfix col-12" style="padding-left: 30px;">
															├ <div class="custom-control custom-checkbox d-inline">

																<input class="custom-control-input permission_<?php echo PERMISSION_VIP_REWARD_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_VIP_REWARD_VIEW;?>" type="<?php echo (($permissions[PERMISSION_VIP_REWARD_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_VIP_REWARD_VIEW;?>_<?php echo PERMISSION_VIP_REWARD_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_VIP_REWARD_UPDATE;?>" <?php echo (($permissions[PERMISSION_VIP_REWARD_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_VIP_REWARD_UPDATE]['upline']) ? 'checked' : '');?>>

																<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_VIP_REWARD_VIEW;?>_<?php echo PERMISSION_VIP_REWARD_UPDATE;?>">
													...
													<?php if($permissions[PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL]['upline'] == TRUE):?>
														<div class="form-group clearfix col-12" style="padding-left: 30px;">
															├ <div class="custom-control custom-checkbox d-inline">

																<input class="custom-control-input permission_<?php echo PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL;?> checkbox_option sub_permissions_<?php echo PERMISSION_VIP_REWARD_VIEW;?>" type="<?php echo (($permissions[PERMISSION_VIP_REWARD_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_VIP_REWARD_VIEW;?>_<?php echo PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL;?>" name="permissions[]" value="<?php echo PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL;?>" <?php echo (($permissions[PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL]['upline']) ? 'checked' : '');?>>

																<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_VIP_REWARD_VIEW;?>_<?php echo PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL;?>">
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_FINGERPRINT_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_FINGERPRINT_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_FINGERPRINT_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_FINGERPRINT_VIEW;?>" <?php echo (($permissions[PERMISSION_FINGERPRINT_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_FINGERPRINT_VIEW]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BLACKLIST_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_BLACKLIST_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BLACKLIST_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BLACKLIST_VIEW;?>_<?php echo PERMISSION_BLACKLIST_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_BLACKLIST_DELETE;?>" <?php echo (($permissions[PERMISSION_BLACKLIST_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BLACKLIST_DELETE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_WHITELIST_ADD;?> checkbox_option sub_permissions_<?php echo PERMISSION_WHITELIST_VIEW;?>" type="<?php echo (($permissions[PERMISSION_WHITELIST_ADD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_WHITELIST_VIEW;?>_<?php echo PERMISSION_WHITELIST_ADD;?>" name="permissions[]" value="<?php echo PERMISSION_WHITELIST_ADD;?>" <?php echo (($permissions[PERMISSION_WHITELIST_ADD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_WHITELIST_ADD]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_SYSTEM_MESSAGE_ADD;?> checkbox_option sub_permissions_<?php echo PERMISSION_SYSTEM_MESSAGE_VIEW;?>" type="<?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_ADD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SYSTEM_MESSAGE_VIEW;?>_<?php echo PERMISSION_SYSTEM_MESSAGE_ADD;?>" name="permissions[]" value="<?php echo PERMISSION_SYSTEM_MESSAGE_ADD;?>" <?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_ADD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_ADD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_SYSTEM_MESSAGE_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_SYSTEM_MESSAGE_VIEW;?>" type="<?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SYSTEM_MESSAGE_VIEW;?>_<?php echo PERMISSION_SYSTEM_MESSAGE_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_SYSTEM_MESSAGE_UPDATE;?>" <?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_UPDATE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_SYSTEM_MESSAGE_USER_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_USER_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SYSTEM_MESSAGE_USER_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_SYSTEM_MESSAGE_USER_VIEW;?>" <?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_USER_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_USER_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_SYSTEM_MESSAGE_USER_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_SYSTEM_MESSAGE_USER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_USER_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SYSTEM_MESSAGE_USER_VIEW;?>_<?php echo PERMISSION_SYSTEM_MESSAGE_USER_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_SYSTEM_MESSAGE_USER_UPDATE;?>" <?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_USER_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_USER_UPDATE]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_SYSTEM_MESSAGE_USER_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_SYSTEM_MESSAGE_USER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_USER_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SYSTEM_MESSAGE_USER_VIEW;?>_<?php echo PERMISSION_SYSTEM_MESSAGE_USER_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_SYSTEM_MESSAGE_USER_DELETE;?>" <?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_USER_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_SYSTEM_MESSAGE_USER_DELETE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_ADMIN_LOG_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_ADMIN_LOG_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_ADMIN_LOG_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_ADMIN_LOG_VIEW;?>" <?php echo (($permissions[PERMISSION_ADMIN_LOG_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_ADMIN_LOG_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_SUB_ACCOUNT_LOG_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_SUB_ACCOUNT_LOG_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SUB_ACCOUNT_LOG_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_SUB_ACCOUNT_LOG_VIEW;?>" <?php echo (($permissions[PERMISSION_SUB_ACCOUNT_LOG_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_SUB_ACCOUNT_LOG_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_SUB_ACCOUNT_PLAYER_LOG_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_SUB_ACCOUNT_PLAYER_LOG_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SUB_ACCOUNT_PLAYER_LOG_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_SUB_ACCOUNT_PLAYER_LOG_VIEW;?>" <?php echo (($permissions[PERMISSION_SUB_ACCOUNT_PLAYER_LOG_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_SUB_ACCOUNT_PLAYER_LOG_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<!-- Player log (PERMISSION_PLAYER_LOG_VIEW)  -->
												<?php if ($permissions[PERMISSION_PLAYER_LOG_VIEW]['upline'] == TRUE) : ?>

													<div class="form-group clearfix col-12">

														<div class="custom-control custom-checkbox d-inline">

															<input class="custom-control-input permission_<?php echo PERMISSION_PLAYER_LOG_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_PLAYER_LOG_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_PLAYER_LOG_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_PLAYER_LOG_VIEW; ?>" <?php echo (($permissions[PERMISSION_PLAYER_LOG_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_PLAYER_LOG_VIEW]['upline']) ? 'checked' : ''); ?>>

															<label class="custom-control-label font-weight-normal" for="permission_<?php echo PERMISSION_PLAYER_LOG_VIEW; ?>">

																<?php echo $this->lang->line('title_player_log'); ?> &nbsp;
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BLOG_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_BLOG_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BLOG_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_BLOG_VIEW;?>" <?php echo (($permissions[PERMISSION_BLOG_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BLOG_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BLOG_FRONTEND_VIEW;?> checkbox_option sub_permissions_<?php echo PERMISSION_BLOG_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BLOG_FRONTEND_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BLOG_VIEW;?>_<?php echo PERMISSION_BLOG_FRONTEND_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_BLOG_FRONTEND_VIEW;?>" <?php echo (($permissions[PERMISSION_BLOG_FRONTEND_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BLOG_FRONTEND_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BLOG_ADD;?> checkbox_option sub_permissions_<?php echo PERMISSION_BLOG_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BLOG_ADD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BLOG_VIEW;?>_<?php echo PERMISSION_BLOG_ADD;?>" name="permissions[]" value="<?php echo PERMISSION_BLOG_ADD;?>" <?php echo (($permissions[PERMISSION_BLOG_ADD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BLOG_ADD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BLOG_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_BLOG_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BLOG_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BLOG_VIEW;?>_<?php echo PERMISSION_BLOG_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_BLOG_DELETE;?>" <?php echo (($permissions[PERMISSION_BLOG_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BLOG_DELETE]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BLOG_CATEGORY_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_BLOG_CATEGORY_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BLOG_CATEGORY_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_BLOG_CATEGORY_VIEW;?>" <?php echo (($permissions[PERMISSION_BLOG_CATEGORY_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BLOG_CATEGORY_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BLOG_CATEGORY_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_BLOG_CATEGORY_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BLOG_CATEGORY_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BLOG_CATEGORY_VIEW;?>_<?php echo PERMISSION_BLOG_CATEGORY_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_BLOG_CATEGORY_DELETE;?>" <?php echo (($permissions[PERMISSION_BLOG_CATEGORY_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BLOG_CATEGORY_DELETE]['upline']) ? 'checked' : '');?>>
									...
									<div class="form-group row">
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_AVATAR_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_AVATAR_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_AVATAR_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_AVATAR_VIEW;?>" <?php echo (($permissions[PERMISSION_AVATAR_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_AVATAR_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_AVATAR_ADD;?> checkbox_option sub_permissions_<?php echo PERMISSION_AVATAR_VIEW;?>" type="<?php echo (($permissions[PERMISSION_AVATAR_ADD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_AVATAR_VIEW;?>_<?php echo PERMISSION_AVATAR_ADD;?>" name="permissions[]" value="<?php echo PERMISSION_AVATAR_ADD;?>" <?php echo (($permissions[PERMISSION_AVATAR_ADD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_AVATAR_ADD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_AVATAR_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_AVATAR_VIEW;?>" type="<?php echo (($permissions[PERMISSION_AVATAR_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_AVATAR_VIEW;?>_<?php echo PERMISSION_AVATAR_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_AVATAR_DELETE;?>" <?php echo (($permissions[PERMISSION_AVATAR_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_AVATAR_DELETE]['upline']) ? 'checked' : '');?>>
										...
										<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
											...
											<div class="form-group row">
												...
												<?php if($permissions[PERMISSION_ANNOUNCEMENT_ADD]['upline'] == TRUE):?>
										...
										<?php if ($permissions[PERMISSION_MARQUEE_VIEW]['upline'] == TRUE) : ?>
											...
											<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
												...
												<div class="form-group row">
													...
													<?php if ($permissions[PERMISSION_MARQUEE_ADD]['upline'] == TRUE) : ?>
													...
													<?php if ($permissions[PERMISSION_MARQUEE_UPDATE]['upline'] == TRUE) : ?>
														...
														<div class="form-group clearfix col-12" style="padding-left: 30px;">
															...
															├ <div class="custom-control custom-checkbox d-inline">
																...
																<input class="custom-control-input permission_<?php echo PERMISSION_MARQUEE_UPDATE; ?> checkbox_option sub_permissions_<?php echo PERMISSION_MARQUEE_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_MARQUEE_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_MARQUEE_VIEW; ?>_<?php echo PERMISSION_MARQUEE_UPDATE; ?>" name="permissions[]" value="<?php echo PERMISSION_MARQUEE_UPDATE; ?>" <?php echo (($permissions[PERMISSION_MARQUEE_UPDATE]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_MARQUEE_UPDATE]['upline']) ? 'checked' : ''); ?>>
													...
													<?php if ($permissions[PERMISSION_MARQUEE_DELETE]['upline'] == TRUE) : ?>
														...
														<div class="form-group clearfix col-12" style="padding-left: 30px;">
															...
															├ <div class="custom-control custom-checkbox d-inline">
																...
																<input class="custom-control-input permission_<?php echo PERMISSION_MARQUEE_DELETE; ?> checkbox_option sub_permissions_<?php echo PERMISSION_MARQUEE_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_MARQUEE_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_MARQUEE_VIEW; ?>_<?php echo PERMISSION_MARQUEE_DELETE; ?>" name="permissions[]" value="<?php echo PERMISSION_MARQUEE_DELETE; ?>" <?php echo (($permissions[PERMISSION_MARQUEE_DELETE]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_MARQUEE_DELETE]['upline']) ? 'checked' : ''); ?>>
										...
										<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
											...
											<div class="form-group row">
												...
												<?php if($permissions[PERMISSION_BANK_ADD]['upline'] == TRUE):?>
										...
										<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
											...
											<div class="form-group row">
												...
												<?php if($permissions[PERMISSION_BANK_ACCOUNT_ADD]['upline'] == TRUE):?>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BANK_ACCOUNT_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_BANK_ACCOUNT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BANK_ACCOUNT_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BANK_ACCOUNT_VIEW;?>_<?php echo PERMISSION_BANK_ACCOUNT_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_BANK_ACCOUNT_UPDATE;?>" <?php echo (($permissions[PERMISSION_BANK_ACCOUNT_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BANK_ACCOUNT_UPDATE]['upline']) ? 'checked' : '');?>>
										...
										<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
											...
											<div class="form-group row">
												...
												<?php if($permissions[PERMISSION_BANNER_ADD]['upline'] == TRUE):?>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BANNER_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_BANNER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BANNER_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BANNER_VIEW;?>_<?php echo PERMISSION_BANNER_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_BANNER_UPDATE;?>" <?php echo (($permissions[PERMISSION_BANNER_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BANNER_UPDATE]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BANNER_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_BANNER_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BANNER_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BANNER_VIEW;?>_<?php echo PERMISSION_BANNER_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_BANNER_DELETE;?>" <?php echo (($permissions[PERMISSION_BANNER_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BANNER_DELETE]['upline']) ? 'checked' : '');?>>
										...
										<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
											...
											<div class="form-group row">
												...
												<?php if($permissions[PERMISSION_BONUS_ADD]['upline'] == TRUE):?>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BONUS_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_BONUS_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BONUS_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BONUS_VIEW;?>_<?php echo PERMISSION_BONUS_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_BONUS_UPDATE;?>" <?php echo (($permissions[PERMISSION_BONUS_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BONUS_UPDATE]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BONUS_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_BONUS_VIEW;?>" type="<?php echo (($permissions[PERMISSION_BONUS_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BONUS_VIEW;?>_<?php echo PERMISSION_BONUS_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_BONUS_DELETE;?>" <?php echo (($permissions[PERMISSION_BONUS_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BONUS_DELETE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CONTACT_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_CONTACT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_CONTACT_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_CONTACT_VIEW;?>_<?php echo PERMISSION_CONTACT_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_CONTACT_UPDATE;?>" <?php echo (($permissions[PERMISSION_CONTACT_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CONTACT_UPDATE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CURRENCIES_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_CURRENCIES_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_CURRENCIES_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_CURRENCIES_VIEW;?>" <?php echo (($permissions[PERMISSION_CURRENCIES_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CURRENCIES_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CURRENCIES_ADD;?> checkbox_option sub_permissions_<?php echo PERMISSION_CURRENCIES_VIEW;?>" type="<?php echo (($permissions[PERMISSION_CURRENCIES_ADD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_CURRENCIES_VIEW;?>_<?php echo PERMISSION_CURRENCIES_ADD;?>" name="permissions[]" value="<?php echo PERMISSION_CURRENCIES_ADD;?>" <?php echo (($permissions[PERMISSION_CURRENCIES_ADD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CURRENCIES_ADD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CURRENCIES_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_CURRENCIES_VIEW;?>" type="<?php echo (($permissions[PERMISSION_CURRENCIES_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_CURRENCIES_VIEW;?>_<?php echo PERMISSION_CURRENCIES_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_CURRENCIES_UPDATE;?>" <?php echo (($permissions[PERMISSION_CURRENCIES_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CURRENCIES_UPDATE]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CURRENCIES_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_CURRENCIES_VIEW;?>" type="<?php echo (($permissions[PERMISSION_CURRENCIES_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_CURRENCIES_VIEW;?>_<?php echo PERMISSION_CURRENCIES_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_CURRENCIES_DELETE;?>" <?php echo (($permissions[PERMISSION_CURRENCIES_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CURRENCIES_DELETE]['upline']) ? 'checked' : '');?>>
										...
										<?php if($permissions[PERMISSION_GAME_MAINTENANCE_VIEW]['upline'] == TRUE || $permissions[PERMISSION_SUB_GAME_VIEW]['upline'] == TRUE):?>
										...
										<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_GAME_MAINTENANCE_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_GAME_MAINTENANCE_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_GAME_MAINTENANCE_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_GAME_MAINTENANCE_VIEW;?>" <?php echo (($permissions[PERMISSION_GAME_MAINTENANCE_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_GAME_MAINTENANCE_VIEW]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<?php if($permissions[PERMISSION_SUB_GAME_ADD]['upline'] == TRUE):?>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													...
													├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_SUB_GAME_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_SUB_GAME_VIEW;?>" type="<?php echo (($permissions[PERMISSION_SUB_GAME_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SUB_GAME_VIEW;?>_<?php echo PERMISSION_SUB_GAME_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_SUB_GAME_UPDATE;?>" <?php echo (($permissions[PERMISSION_SUB_GAME_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_SUB_GAME_UPDATE]['upline']) ? 'checked' : '');?>>
										...
										<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
											...
											<div class="form-group row">
												...
												<?php if($permissions[PERMISSION_GROUP_ADD]['upline'] == TRUE):?>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_GROUP_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_GROUP_VIEW;?>" type="<?php echo (($permissions[PERMISSION_GROUP_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_GROUP_VIEW;?>_<?php echo PERMISSION_GROUP_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_GROUP_UPDATE;?>" <?php echo (($permissions[PERMISSION_GROUP_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_GROUP_UPDATE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<?php echo $this->lang->line('title_ranking');?> &nbsp; 
												...
												<?php if($permissions[PERMISSION_LEVEL_ADD]['upline'] == TRUE):?>
												...
												<?php if($permissions[PERMISSION_LEVEL_EXECUTE_ADD]['upline'] == TRUE):?>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_MATCH_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_MATCH_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_MATCH_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_MATCH_VIEW;?>" <?php echo (($permissions[PERMISSION_MATCH_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_MATCH_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_MATCH_ADD;?> checkbox_option sub_permissions_<?php echo PERMISSION_MATCH_VIEW;?>" type="<?php echo (($permissions[PERMISSION_MATCH_ADD]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_MATCH_VIEW;?>_<?php echo PERMISSION_MATCH_ADD;?>" name="permissions[]" value="<?php echo PERMISSION_MATCH_ADD;?>" <?php echo (($permissions[PERMISSION_MATCH_ADD]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_MATCH_ADD]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_MATCH_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_MATCH_VIEW;?>" type="<?php echo (($permissions[PERMISSION_MATCH_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_MATCH_VIEW;?>_<?php echo PERMISSION_MATCH_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_MATCH_UPDATE;?>" <?php echo (($permissions[PERMISSION_MATCH_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_MATCH_UPDATE]['upline']) ? 'checked' : '');?>>
										...
										<?php if($permissions[PERMISSION_PAYMENT_GATEWAY_VIEW]['upline'] == TRUE || $permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW]['upline'] == TRUE):?>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<?php echo $this->lang->line('title_payment_gateway_limited');?> &nbsp; 
												...
												<?php if($permissions[PERMISSION_PAYMENT_GATEWAY_LIMITED_ADD]['upline'] == TRUE):?>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_PROMOTION_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_PROMOTION_VIEW;?>" type="<?php echo (($permissions[PERMISSION_PROMOTION_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_PROMOTION_VIEW;?>_<?php echo PERMISSION_PROMOTION_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_PROMOTION_DELETE;?>" <?php echo (($permissions[PERMISSION_PROMOTION_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_PROMOTION_DELETE]['upline']) ? 'checked' : '');?>>
										...
										<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
											...
											<div class="form-group row">
												...
												<?php if($permissions[PERMISSION_WITHDRAWAL_FEE_RATE_ADD]['upline'] == TRUE):?>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_WITHDRAWAL_FEE_RATE_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_WITHDRAWAL_FEE_RATE_VIEW;?>" type="<?php echo (($permissions[PERMISSION_WITHDRAWAL_FEE_RATE_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_WITHDRAWAL_FEE_RATE_VIEW;?>_<?php echo PERMISSION_WITHDRAWAL_FEE_RATE_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_WITHDRAWAL_FEE_RATE_DELETE;?>" <?php echo (($permissions[PERMISSION_WITHDRAWAL_FEE_RATE_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_WITHDRAWAL_FEE_RATE_DELETE]['upline']) ? 'checked' : '');?>>
										...
										<div class="form-group clearfix col-12 col-sm-6 col-md-4 col-lg-3 pt-3">
											...
											<div class="form-group row">
												...
												<?php if($permissions[PERMISSION_SEO_ADD]['upline'] == TRUE):?>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_SEO_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_SEO_VIEW;?>" type="<?php echo (($permissions[PERMISSION_SEO_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SEO_VIEW;?>_<?php echo PERMISSION_SEO_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_SEO_UPDATE;?>" <?php echo (($permissions[PERMISSION_SEO_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_SEO_UPDATE]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_SEO_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_SEO_VIEW;?>" type="<?php echo (($permissions[PERMISSION_SEO_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_SEO_VIEW;?>_<?php echo PERMISSION_SEO_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_SEO_DELETE;?>" <?php echo (($permissions[PERMISSION_SEO_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_SEO_UPDATE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CONTENT_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_CONTENT_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_CONTENT_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_CONTENT_VIEW;?>" <?php echo (($permissions[PERMISSION_CONTENT_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CONTENT_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CONTENT_FRONTEND_VIEW;?> checkbox_option sub_permissions_<?php echo PERMISSION_CONTENT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_CONTENT_FRONTEND_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_CONTENT_VIEW;?>_<?php echo PERMISSION_CONTENT_FRONTEND_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_CONTENT_FRONTEND_VIEW;?>" <?php echo (($permissions[PERMISSION_CONTENT_FRONTEND_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CONTENT_FRONTEND_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CONTENT_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_CONTENT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_CONTENT_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_CONTENT_VIEW;?>_<?php echo PERMISSION_CONTENT_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_CONTENT_UPDATE;?>" <?php echo (($permissions[PERMISSION_CONTENT_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CONTENT_UPDATE]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_CONTENT_DELETE;?> checkbox_option sub_permissions_<?php echo PERMISSION_CONTENT_VIEW;?>" type="<?php echo (($permissions[PERMISSION_CONTENT_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_CONTENT_VIEW;?>_<?php echo PERMISSION_CONTENT_DELETE;?>" name="permissions[]" value="<?php echo PERMISSION_CONTENT_DELETE;?>" <?php echo (($permissions[PERMISSION_CONTENT_DELETE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_CONTENT_DELETE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_TAG_VIEW;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_TAG_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_TAG_VIEW;?>" name="permissions[]" value="<?php echo PERMISSION_TAG_VIEW;?>" <?php echo (($permissions[PERMISSION_TAG_VIEW]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_TAG_VIEW]['upline']) ? 'checked' : '');?>>
												...
												<div class="form-group clearfix col-12" style="padding-left: 30px;">
													 ...
													 ├ <div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_TAG_UPDATE;?> checkbox_option sub_permissions_<?php echo PERMISSION_TAG_VIEW;?>" type="<?php echo (($permissions[PERMISSION_TAG_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_TAG_VIEW;?>_<?php echo PERMISSION_TAG_UPDATE;?>" name="permissions[]" value="<?php echo PERMISSION_TAG_UPDATE;?>" <?php echo (($permissions[PERMISSION_TAG_UPDATE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_TAG_UPDATE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_DEPOSIT_CREDIT_CARD_ANNOUNCEMENT;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_DEPOSIT_CREDIT_CARD_ANNOUNCEMENT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_DEPOSIT_CREDIT_CARD_ANNOUNCEMENT;?>" name="permissions[]" value="<?php echo PERMISSION_DEPOSIT_CREDIT_CARD_ANNOUNCEMENT;?>" <?php echo (($permissions[PERMISSION_DEPOSIT_CREDIT_CARD_ANNOUNCEMENT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_DEPOSIT_CREDIT_CARD_ANNOUNCEMENT]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_DEPOSIT_HYPERMARKET_ANNOUNCEMENT;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_DEPOSIT_HYPERMARKET_ANNOUNCEMENT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_DEPOSIT_HYPERMARKET_ANNOUNCEMENT;?>" name="permissions[]" value="<?php echo PERMISSION_DEPOSIT_HYPERMARKET_ANNOUNCEMENT;?>" <?php echo (($permissions[PERMISSION_DEPOSIT_HYPERMARKET_ANNOUNCEMENT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_DEPOSIT_HYPERMARKET_ANNOUNCEMENT]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_WITHDRAWAL_OFFLINE_ANNOUNCEMENT;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_WITHDRAWAL_OFFLINE_ANNOUNCEMENT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_WITHDRAWAL_OFFLINE_ANNOUNCEMENT;?>" name="permissions[]" value="<?php echo PERMISSION_WITHDRAWAL_OFFLINE_ANNOUNCEMENT;?>" <?php echo (($permissions[PERMISSION_WITHDRAWAL_OFFLINE_ANNOUNCEMENT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_WITHDRAWAL_OFFLINE_ANNOUNCEMENT]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_BLACKLIST_ANNOUNCEMENT;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_BLACKLIST_ANNOUNCEMENT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_BLACKLIST_ANNOUNCEMENT;?>" name="permissions[]" value="<?php echo PERMISSION_BLACKLIST_ANNOUNCEMENT;?>" <?php echo (($permissions[PERMISSION_BLACKLIST_ANNOUNCEMENT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_BLACKLIST_ANNOUNCEMENT]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_DEPOSIT_ONLINE_NOTICE;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_DEPOSIT_ONLINE_NOTICE]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_DEPOSIT_ONLINE_NOTICE;?>" name="permissions[]" value="<?php echo PERMISSION_DEPOSIT_ONLINE_NOTICE;?>" <?php echo (($permissions[PERMISSION_DEPOSIT_ONLINE_NOTICE]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_DEPOSIT_ONLINE_NOTICE]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_RISK_MANAGEMENT;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_RISK_MANAGEMENT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_RISK_MANAGEMENT;?>" name="permissions[]" value="<?php echo PERMISSION_RISK_MANAGEMENT;?>" <?php echo (($permissions[PERMISSION_RISK_MANAGEMENT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_RISK_MANAGEMENT]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_FINGERPRINT_MANAGEMENT;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_FINGERPRINT_MANAGEMENT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_FINGERPRINT_MANAGEMENT;?>" name="permissions[]" value="<?php echo PERMISSION_FINGERPRINT_MANAGEMENT;?>" <?php echo (($permissions[PERMISSION_FINGERPRINT_MANAGEMENT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_FINGERPRINT_MANAGEMENT]['upline']) ? 'checked' : '');?>>
											...
											<div class="form-group row">
												...
												<div class="form-group clearfix col-12">
													...
													<div class="custom-control custom-checkbox d-inline">
														...
														<input class="custom-control-input permission_<?php echo PERMISSION_LEVEL_MANAGEMENT;?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_LEVEL_MANAGEMENT]['upline'] == FALSE) ? 'button' : 'checkbox');?>" id="permission_<?php echo PERMISSION_LEVEL_MANAGEMENT;?>" name="permissions[]" value="<?php echo PERMISSION_LEVEL_MANAGEMENT;?>" <?php echo (($permissions[PERMISSION_LEVEL_MANAGEMENT]['upline'] == FALSE) ? 'disabled' : '');?> <?php echo (($permissions[PERMISSION_LEVEL_MANAGEMENT]['upline']) ? 'checked' : '');?>>
						...
						$.ajax({url: form.attr('action'),
							...
							success: function (data) {
								...
								if(json.status == '<?php echo EXIT_SUCCESS;?>') {
									...
									parent.$('#user_role-table').DataTable().ajax.reload();
			...
			form.validate({
				...
				messages: {
					...
					level: {
						...
						required: "<?php echo str_replace('%s', strtolower($this->lang->line('label_level')), $this->lang->line('error_select_level'));?>",

						digits: "<?php echo str_replace('%s', strtolower($this->lang->line('label_level')), $this->lang->line('error_only_digits_allowed'));?>",
