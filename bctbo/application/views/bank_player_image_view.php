...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
					...
					<div class="col-12">
						...
						<div class="card">
							...
							<div class="card-header">
								...
								<form action="<?php echo site_url('bank/playerImageSearch'); ?>" id="bank_player_image-form" name="bank_player_image-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
									...
									<div class="form-group row">
										...
										<div class="col-md-3">
											...
											<div class="row mb-2">
												...
												<label class="col-4 col-form-label col-form-label-sm font-weight-normal">Full Name</label>

												<div class="col-8">

													<input type="text" class="form-control form-control-sm" id="full_name" name="full_name" value="<?php echo (isset($data_search['full_name']) ? $data_search['full_name'] : ''); ?>">
										...
										<div class="col-md-3">
											...
											<div class="row mb-2">
												...
												<label class="col-4 col-form-label col-form-label-sm font-weight-normal">Birthday</label>

												<div class="col-8 input-group date" id="from_birthday" data-target-input="nearest">

													<input type="text" id="birthday" name="birthday" class="form-control form-control-sm col-12 datetimepicker-input" value="<?php echo (isset($data_search['birthday']) ? $data_search['birthday'] : date('Y-m-d')); ?>" data-target="#from_birthday" />

													<div class="input-group-append" data-target="#from_birthday" data-toggle="datetimepicker">
											...
											<div class="row mb-2">
												...
												<label class="col-4 col-form-label col-form-label-sm font-weight-normal">Message</label>

												<div class="col-8">

													<input type="text" class="form-control form-control-sm" id="message" name="message" value="">
										...
										<div class="col-md-3">
											...
											<div class="row mb-2">
												...
												<div class="col-8">
													...
													<select class="form-control form-control-sm select2bs4 col-12" id="player_bank_image_type" name="player_bank_image_type">
							...
							<div class="card-body">
								...
								<table id="bank_player_image-table" class="table table-striped table-bordered table-hover" style="width:100%;">
									...
									<thead>
										...
										<tr>
											...
											<th width="150"><?php echo $this->lang->line('label_fullname'); ?></th>

											<th width="80"><?php echo $this->lang->line('label_type'); ?></th>

											<th width="80"><?php echo 'Image';?></th>

											<th width="200"><?php echo $this->lang->line('label_username'); ?></th>

											<th width="100"><?php echo $this->lang->line('label_card'); ?></th>

											<th width="200"><?php echo $this->lang->line('label_birthday'); ?></th>

											<th width="100"><?php echo $this->lang->line('label_message'); ?></th>
	...
	<script type="text/javascript">
		function fastSetDateSearch(from, to, birthday, message) {
		...
		$(document).ready(function() {
			...
			var form = $('#bank_player_image-form');
				...
				if (is_allowed == true) {
					...
					$.ajax({
						...
						data: {
							...
							player_bank_image_type: $('#player_bank_image_type').val(),
						...
						success: function(data) {
							...
							if (json.status == '<?php echo EXIT_SUCCESS; ?>') {
								...
								$('#bank_player_image-table').DataTable().ajax.reload();
			...
			$('#bank_player_image-table').DataTable({
				...
				"ajax": {
					...
					"url": "<?php echo site_url('bank/playerListingImage'); ?>",
		...
		function updateBankImage(id) {

			layer.open({

				type: 2,

				area: [((browser_width < 800) ? '800px' : '800px'), ((browser_width < 800) ? '800px' : '800px')],
				...
				title: '<?php echo $this->lang->line('title_bank_player_image'); ?>',

				content: '<?php echo base_url('bank/playerBankImageEdit/'); ?>' + id
		...
		function updateData(id) {
			...
			layer.open({
				...
				content: '<?php echo base_url('bank/playerBankImageEditData/'); ?>' + id
