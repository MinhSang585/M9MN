<nav class="main-header navbar navbar-expand navbar-white navbar-light">
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown">
			<a class="nav-link" id="agent_approve" data-toggle="dropdown" href="#" aria-expanded="true">
				<i class="fas fa-user-tie"></i>
				<span class="badge badge-warning navbar-badge" id="agent_approve_span">0</span>
			</a>
			<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;" id="total_agent_approve_content">
				<span class="dropdown-item dropdown-header">New agent pending</span>
	        </div>
		</li>
		<li class="nav-item dropdown">
