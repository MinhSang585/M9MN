...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
								...
								<table id="player-table" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th width="80"><?php echo $this->lang->line('label_remark');?></th> <!-- row 16 -->
	...
	<script type="text/javascript">
		...
		function changePasswordWithdrawal(id) {
			layer.open({
				type: 2,
				area: [((browser_width < 600) ? '100%': '500px'), ((browser_width < 600) ? '100%': '380px')],
				fixed: false,
				maxmin: true,
				scrollbar: false,
				title: '<?php echo $this->lang->line('title_change_password_bank');?>',
				content: '<?php echo base_url('player/passwordWithdrawal/');?>' + id
			});
		}
		...
		function kick_player(id){
				layer.open({
				type: 2,
				area: [((browser_width < 600) ? '100%': '360px'), ((browser_width < 600) ? '100%': '360px')],
				fixed: false,
				maxmin: true,
				scrollbar: false,
				title: '<?php echo $this->lang->line('title_kick_player');?>',
				content: '<?php echo base_url('player/kickInfo/');?>' + id
			});
		}
		 ...
		 */
		function updateUpline(id){
			layer.open({
				type: 2,
				area: [((browser_width < 600) ? '100%': '400px'), ((browser_width < 600) ? '100%': '280px')],
				fixed: false,
				maxmin: true,
				scrollbar: false,
				title: '<?php echo $this->lang->line('button_change_upline');?>',
				content: '<?php echo base_url('player/edit_upline_player/');?>' + id
			});
		}
