										...
										<select class="form-control select2bs4" id="level" name="level">
											...
											if (!empty($level_list)) {
												foreach ($level_list as $role_level) {
													echo '<option value="' . $role_level . '"' . ($level == $role_level ? ' selected' : '') . '>' . $role_level . '</option>';
												}
											}
											?>
										</select>
												...
												<?php if ($permissions[PERMISSION_KYC_ADD]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12" style="padding-left: 30px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_KYC_ADD; ?> checkbox_option sub_permissions_<?php echo PERMISSION_KYC_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_KYC_ADD]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_KYC_VIEW; ?>_<?php echo PERMISSION_KYC_ADD; ?>" name="permissions[]" value="<?php echo PERMISSION_KYC_ADD; ?>" <?php echo (($permissions[PERMISSION_KYC_ADD]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_KYC_ADD]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_AGENT_VIEW]['upline'] == TRUE) : ?>
													<div class="form-group clearfix col-12">
														...
														<div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_AGENT_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_AGENT_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_AGENT_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_AGENT_VIEW; ?>" <?php echo (($permissions[PERMISSION_AGENT_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_AGENT_VIEW]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_AGENT_REPORT_EXPORT_EXCEL]['upline'] == TRUE) : ?>
													<div class="form-group clearfix col-12" style="padding-left: 30px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_AGENT_REPORT_EXPORT_EXCEL; ?> checkbox_option sub_permissions_<?php echo PERMISSION_AGENT_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_AGENT_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_AGENT_VIEW; ?>_<?php echo PERMISSION_AGENT_REPORT_EXPORT_EXCEL; ?>" name="permissions[]" value="<?php echo PERMISSION_AGENT_REPORT_EXPORT_EXCEL; ?>" <?php echo (($permissions[PERMISSION_AGENT_UPDATE]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_AGENT_REPORT_EXPORT_EXCEL]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_VIP_REWARD_VIEW]['upline'] == TRUE) : ?>
													<div class="form-group clearfix col-12">
														...
														<div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_VIP_REWARD_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_VIP_REWARD_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_VIP_REWARD_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_VIP_REWARD_VIEW; ?>" <?php echo (($permissions[PERMISSION_VIP_REWARD_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_VIP_REWARD_VIEW]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL]['upline'] == TRUE) : ?>
													<div class="form-group clearfix col-12" style="padding-left: 30px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL; ?> checkbox_option sub_permissions_<?php echo PERMISSION_VIP_REWARD_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_VIP_REWARD_VIEW; ?>_<?php echo PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL; ?>" name="permissions[]" value="<?php echo PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL; ?>" <?php echo (($permissions[PERMISSION_VIP_REWARD_UPDATE]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_ANNOUNCEMENT_VIEW]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12">
														...
														<div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_ANNOUNCEMENT_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_ANNOUNCEMENT_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_ANNOUNCEMENT_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_ANNOUNCEMENT_VIEW; ?>" <?php echo (($permissions[PERMISSION_ANNOUNCEMENT_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_ANNOUNCEMENT_VIEW]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_ANNOUNCEMENT_ADD]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12" style="padding-left: 30px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_ANNOUNCEMENT_ADD; ?> checkbox_option sub_permissions_<?php echo PERMISSION_ANNOUNCEMENT_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_ANNOUNCEMENT_ADD]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_ANNOUNCEMENT_VIEW; ?>_<?php echo PERMISSION_ANNOUNCEMENT_ADD; ?>" name="permissions[]" value="<?php echo PERMISSION_ANNOUNCEMENT_ADD; ?>" <?php echo (($permissions[PERMISSION_ANNOUNCEMENT_ADD]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_ANNOUNCEMENT_ADD]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_BANK_ACCOUNT_VIEW]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12">
														...
														<div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_BANK_ACCOUNT_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_BANK_ACCOUNT_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_BANK_ACCOUNT_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_BANK_ACCOUNT_VIEW; ?>" <?php echo (($permissions[PERMISSION_BANK_ACCOUNT_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_BANK_ACCOUNT_VIEW]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_BANK_ACCOUNT_ADD]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12" style="padding-left: 30px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_BANK_ACCOUNT_ADD; ?> checkbox_option sub_permissions_<?php echo PERMISSION_BANK_ACCOUNT_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_BANK_ACCOUNT_ADD]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_BANK_ACCOUNT_VIEW; ?>_<?php echo PERMISSION_BANK_ACCOUNT_ADD; ?>" name="permissions[]" value="<?php echo PERMISSION_BANK_ACCOUNT_ADD; ?>" <?php echo (($permissions[PERMISSION_BANK_ACCOUNT_ADD]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_BANK_ACCOUNT_ADD]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_BANNER_VIEW]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12">
														...
														<div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_BANNER_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_BANNER_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_BANNER_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_BANNER_VIEW; ?>" <?php echo (($permissions[PERMISSION_BANNER_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_BANNER_VIEW]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_BANNER_ADD]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12" style="padding-left: 30px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_BANNER_ADD; ?> checkbox_option sub_permissions_<?php echo PERMISSION_BANNER_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_BANNER_ADD]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_BANNER_VIEW; ?>_<?php echo PERMISSION_BANNER_ADD; ?>" name="permissions[]" value="<?php echo PERMISSION_BANNER_ADD; ?>" <?php echo (($permissions[PERMISSION_BANNER_ADD]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_BANNER_ADD]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_BONUS_VIEW]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12">
														...
														<div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_BONUS_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_BONUS_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_BONUS_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_BONUS_VIEW; ?>" <?php echo (($permissions[PERMISSION_BONUS_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_BONUS_VIEW]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_BONUS_ADD]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12" style="padding-left: 30px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_BONUS_ADD; ?> checkbox_option sub_permissions_<?php echo PERMISSION_BONUS_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_BONUS_ADD]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_BONUS_VIEW; ?>_<?php echo PERMISSION_BONUS_ADD; ?>" name="permissions[]" value="<?php echo PERMISSION_BONUS_ADD; ?>" <?php echo (($permissions[PERMISSION_BONUS_ADD]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_BONUS_ADD]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_CONTACT_VIEW]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12">
														...
														<div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_CONTACT_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_CONTACT_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_CONTACT_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_CONTACT_VIEW; ?>" <?php echo (($permissions[PERMISSION_CONTACT_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_CONTACT_VIEW]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_GROUP_VIEW]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12">
														...
														<div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_GROUP_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_GROUP_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_GROUP_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_GROUP_VIEW; ?>" <?php echo (($permissions[PERMISSION_GROUP_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_GROUP_VIEW]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_GROUP_ADD]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12" style="padding-left: 30px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_GROUP_ADD; ?> checkbox_option sub_permissions_<?php echo PERMISSION_GROUP_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_GROUP_ADD]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_GROUP_VIEW; ?>_<?php echo PERMISSION_GROUP_ADD; ?>" name="permissions[]" value="<?php echo PERMISSION_GROUP_ADD; ?>" <?php echo (($permissions[PERMISSION_GROUP_ADD]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_GROUP_ADD]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_LEVEL_EXECUTE_ADD]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12" style="padding-left: 60px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_LEVEL_EXECUTE_VIEW; ?> checkbox_option sub_permissions_<?php echo PERMISSION_LEVEL_VIEW; ?> sub_permissions_<?php echo PERMISSION_LEVEL_EXECUTE_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_LEVEL_EXECUTE_ADD]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_LEVEL_VIEW; ?>_<?php echo PERMISSION_LEVEL_EXECUTE_VIEW; ?>_<?php echo PERMISSION_LEVEL_EXECUTE_ADD; ?>" name="permissions[]" value="<?php echo PERMISSION_LEVEL_EXECUTE_ADD; ?>" <?php echo (($permissions[PERMISSION_LEVEL_EXECUTE_ADD]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_LEVEL_EXECUTE_ADD]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_LEVEL_EXECUTE_UPDATE]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12" style="padding-left: 60px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_LEVEL_EXECUTE_VIEW; ?> checkbox_option sub_permissions_<?php echo PERMISSION_LEVEL_VIEW; ?> sub_permissions_<?php echo PERMISSION_LEVEL_EXECUTE_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_LEVEL_EXECUTE_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_LEVEL_VIEW; ?>_<?php echo PERMISSION_LEVEL_EXECUTE_VIEW; ?>_<?php echo PERMISSION_LEVEL_EXECUTE_UPDATE; ?>" name="permissions[]" value="<?php echo PERMISSION_LEVEL_EXECUTE_UPDATE; ?>" <?php echo (($permissions[PERMISSION_LEVEL_EXECUTE_UPDATE]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_LEVEL_EXECUTE_UPDATE]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12">
														...
														<div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW; ?>" <?php echo (($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_UPDATE]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12" style="padding-left: 30px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_UPDATE; ?> checkbox_option sub_permissions_<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_UPDATE]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW; ?>_<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_UPDATE; ?>" name="permissions[]" value="<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_UPDATE; ?>" <?php echo (($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_UPDATE]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_UPDATE]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_DELETE]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12" style="padding-left: 30px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_DELETE; ?> checkbox_option sub_permissions_<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_DELETE]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_VIEW; ?>_<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_DELETE; ?>" name="permissions[]" value="<?php echo PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_DELETE; ?>" <?php echo (($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_DELETE]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_PAYMENT_GATEWAY_MAINTENANCE_DELETE]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_WITHDRAWAL_FEE_RATE_VIEW]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12">
														...
														<div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_WITHDRAWAL_FEE_RATE_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_WITHDRAWAL_FEE_RATE_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_WITHDRAWAL_FEE_RATE_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_WITHDRAWAL_FEE_RATE_VIEW; ?>" <?php echo (($permissions[PERMISSION_WITHDRAWAL_FEE_RATE_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_WITHDRAWAL_FEE_RATE_VIEW]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_SEO_VIEW]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12">
														...
														<div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_SEO_VIEW; ?> checkbox_option main_permissions" type="<?php echo (($permissions[PERMISSION_SEO_VIEW]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_SEO_VIEW; ?>" name="permissions[]" value="<?php echo PERMISSION_SEO_VIEW; ?>" <?php echo (($permissions[PERMISSION_SEO_VIEW]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_SEO_VIEW]['selected']) ? 'checked' : ''); ?>>
												...
												<?php if ($permissions[PERMISSION_SEO_ADD]['upline'] == TRUE) : ?>
													...
													<div class="form-group clearfix col-12" style="padding-left: 30px;">
														...
														├ <div class="custom-control custom-checkbox d-inline">
															...
															<input class="custom-control-input permission_<?php echo PERMISSION_SEO_ADD; ?> checkbox_option sub_permissions_<?php echo PERMISSION_SEO_VIEW; ?>" type="<?php echo (($permissions[PERMISSION_SEO_ADD]['upline'] == FALSE) ? 'button' : 'checkbox'); ?>" id="permission_<?php echo PERMISSION_SEO_VIEW; ?>_<?php echo PERMISSION_SEO_ADD; ?>" name="permissions[]" value="<?php echo PERMISSION_SEO_ADD; ?>" <?php echo (($permissions[PERMISSION_SEO_ADD]['upline'] == FALSE) ? 'disabled' : ''); ?> <?php echo (($permissions[PERMISSION_SEO_ADD]['selected']) ? 'checked' : ''); ?>>
						...
						$.ajax({
							...
							success: function(data) {
								...
								if (json.status == '<?php echo EXIT_SUCCESS; ?>') {
									...
									parent.$('#uc6_' + json.response.id).html(json.response.level);
