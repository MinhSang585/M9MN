				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							...
							<?php echo form_open('withdrawal/withdrawal_offline_submit', array('id' => 'player-form', 'name' => 'player-form', 'class' => 'form-horizontal'));?>
											...
											<select class="form-control select2bs4 col-7" id="bank_id" name="bank_id">
												...
												<?php
...

													{
														...
														echo '<option value="' .$bank_list[$i]['bank_id'].'!@#$'. $bank_list[$i]['bank_account_no'] . '">' . $bank_list[$i]['bank_name'] . '</option>';
						...
						$.ajax({url: form.attr('action'),
							...
							success: function (data) {
								...
								if(json.status == '<?php echo EXIT_SUCCESS;?>') {
									...
									else if(json.msg.bank_id_error != '') {
			...
			form.validate({
				...
				messages: {
					...
					bank_id: {
						...
						required: "<?php echo $this->lang->line('error_select_verify_bank');?>",
