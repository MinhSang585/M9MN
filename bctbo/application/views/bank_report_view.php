...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
					...
					<div class="col-12">
						...
						<div class="card">
							...
							<div class="card-header">
								...
								<form action="<?php echo site_url('report/bank_report_search');?>" id="report-form" name="report-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
							...
							<?php echo form_open('export/bank_report_export_excel', 'class="export" id="export_form"');?>
								...
								<table id="report-table" class="table table-striped table-bordered table-hover">
									...
									<thead>
										...
										<tr>
											...
											<th width="120"><?php echo $this->lang->line('button_deposit_offline');?></th>

											<th width="130"><?php echo $this->lang->line('button_withdrawal_offline');?></th>
											
											<th width="130"><?php echo $this->lang->line('label_balance');?></th>
	...
	<script type="text/javascript">
		...
		function loadTable() {
			...
			$('#report-table').DataTable({
				...
				"ajax": {
					...
					"url": "<?php echo site_url('report/bank_report_listing');?>",
		...
		function exportData(){
			...
			$.ajax({url: '<?php echo base_url("export/bank_report_export_excel_check");?>',
