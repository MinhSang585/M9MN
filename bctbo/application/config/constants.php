...
defined('STATUS_REQUEST_AWARD')		OR define('STATUS_REQUEST_AWARD', 3);
...
defined('GAME_L')  		        OR define('GAME_L', 'L');
...
defined('PROMOTION_CALCULATE_TYPE_TOTAL_WINLOSS')			OR define('PROMOTION_CALCULATE_TYPE_TOTAL_WINLOSS', 9);
...
defined('PERMISSION_SUB_GAME_VIEW')								OR define('PERMISSION_SUB_GAME_VIEW',329);
defined('PERMISSION_SUB_GAME_ADD')								OR define('PERMISSION_SUB_GAME_ADD',330);
defined('PERMISSION_SUB_GAME_UPDATE')							OR define('PERMISSION_SUB_GAME_UPDATE',331);
defined('PERMISSION_SUB_GAME_DELETE')							OR define('PERMISSION_SUB_GAME_DELETE',332);
...
defined('PERMISSION_AGENT_VIEW')				            OR define('PERMISSION_AGENT_VIEW',1020);
defined('PERMISSION_AGENT_UPDATE')				            OR define('PERMISSION_AGENT_UPDATE',1021);
defined('PERMISSION_AGENT_REPORT_EXPORT_EXCEL')				OR define('PERMISSION_AGENT_REPORT_EXPORT_EXCEL',1022);
defined('PERMISSION_VIP_REWARD_VIEW')				        OR define('PERMISSION_VIP_REWARD_VIEW',1023);
defined('PERMISSION_VIP_REWARD_UPDATE')				        OR define('PERMISSION_VIP_REWARD_UPDATE',1024);
defined('PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL')	    OR define('PERMISSION_VIP_REWARD_REPORT_EXPORT_EXCEL',1025);
defined('PERMISSION_BANK_REPORT_VIEW')				        OR define('PERMISSION_BANK_REPORT_VIEW',1026);
defined('PERMISSION_BANK_REPORT_EXPORT_EXCEL')	            OR define('PERMISSION_BANK_REPORT_EXPORT_EXCEL',1027);
defined('PERMISSION_PLAYER_LOG_VIEW')				        OR define('PERMISSION_PLAYER_LOG_VIEW',1028);
defined('PERMISSION_KYC_VIEW')				                OR define('PERMISSION_KYC_VIEW',1029);
defined('PERMISSION_KYC_ADD')				                OR define('PERMISSION_KYC_ADD',1030);
defined('PERMISSION_KYC_UPDATE')				            OR define('PERMISSION_KYC_UPDATE',1031);
defined('PERMISSION_MARQUEE_ADD')		                    OR define('PERMISSION_MARQUEE_ADD',1032);
defined('PERMISSION_MARQUEE_UPDATE')		                OR define('PERMISSION_MARQUEE_UPDATE',1033);
defined('PERMISSION_MARQUEE_VIEW')		                    OR define('PERMISSION_MARQUEE_VIEW',1034);
defined('PERMISSION_MARQUEE_DELETE')		                OR define('PERMISSION_MARQUEE_DELETE',1035);
...
defined('LOG_MARQUEE_ADD')			                    OR define('LOG_MARQUEE_ADD', 166);
defined('LOG_MARQUEE_VIEW')			                    OR define('LOG_MARQUEE_VIEW', 167);
defined('LOG_MARQUEE_UPDATE')		                    OR define('LOG_MARQUEE_UPDATE', 168);
defined('LOG_MARQUEE_DELETE')		                    OR define('LOG_MARQUEE_DELETE', 169);
...
|
*/
defined('SYSTEM_MESSAGE_PLATFORM_EN')		OR define('SYSTEM_MESSAGE_PLATFORM_EN', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_CHS') 		OR define('SYSTEM_MESSAGE_PLATFORM_CHS', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_CHT')  	OR define('SYSTEM_MESSAGE_PLATFORM_CHT', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_ID')  		OR define('SYSTEM_MESSAGE_PLATFORM_ID', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_TH')  		OR define('SYSTEM_MESSAGE_PLATFORM_TH', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_VI') 		OR define('SYSTEM_MESSAGE_PLATFORM_VI', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_KM')   	OR define('SYSTEM_MESSAGE_PLATFORM_KM', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_MY')  		OR define('SYSTEM_MESSAGE_PLATFORM_MY', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_MS')  		OR define('SYSTEM_MESSAGE_PLATFORM_MS', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_JA')  		OR define('SYSTEM_MESSAGE_PLATFORM_JA', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_KO')  		OR define('SYSTEM_MESSAGE_PLATFORM_KO', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_BN')  		OR define('SYSTEM_MESSAGE_PLATFORM_BN', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_HI')  		OR define('SYSTEM_MESSAGE_PLATFORM_HI', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_LO')  		OR define('SYSTEM_MESSAGE_PLATFORM_LO', 'm9mbet');
defined('SYSTEM_MESSAGE_PLATFORM_TR')  		OR define('SYSTEM_MESSAGE_PLATFORM_TR', 'm9mbet');
...
defined('BANNER_SOURCE_PATH')		OR define('BANNER_SOURCE_PATH', 'https://m9mbet.com/uploads/banners/');
...
defined('PROMOTION_SOURCE_PATH')	OR define('PROMOTION_SOURCE_PATH', 'https://m9mbet.com/uploads/promotions/');
defined('PROMOTION_FILE_SIZE')		OR define('PROMOTION_FILE_SIZE', 10240);
defined('BANKS_PATH')				OR define('BANKS_PATH', './../uploads/banks/');
defined('BANKS_SOURCE_PATH')		OR define('BANKS_SOURCE_PATH', 'https://m9mbet.com/uploads/banks/');
defined('BANKS_ACCOUNT_IMAGE')      OR define('BANKS_ACCOUNT_IMAGE', './../../../uploads/banks/');
defined('KYC_IMAGE')                OR define('KYC_IMAGE', './../../uploads/kyc/');
...
defined('BANKS_PLAYER_SOURCE_PATH')	OR define('BANKS_PLAYER_SOURCE_PATH', 'https://m9mbet.com/uploads/banksplayer/');
...
defined('BANKS_PLAYER_IDENTIACTION_CARD_SOURCE_PATH')	OR define('BANKS_PLAYER_IDENTIACTION_CARD_SOURCE_PATH', 'https://m9mbet.com/uploads/verify_image/');
...
defined('BANKS_PLAYER_CREDIT_CARD_SOURCE_PATH')	OR define('BANKS_PLAYER_CREDIT_CARD_SOURCE_PATH', 'https://m9mbet.com/uploads/verify_credit_card/');
...
defined('BONUS_SOURCE_PATH')		OR define('BONUS_SOURCE_PATH', 'https://m9mbet.com/uploads/bonus/');
defined('BONUS_FILE_SIZE')			OR define('BONUS_FILE_SIZE', 10240);
defined('AVATAR_PATH')				OR define('AVATAR_PATH', './../uploads/avatar/');
defined('AVATAR_SOURCE_PATH')		OR define('AVATAR_SOURCE_PATH', 'https://m9mbet.com/uploads/avatar/');
...
defined('MATCH_SOURCE_PATH')		OR define('MATCH_SOURCE_PATH', 'https://m9mbet.com/uploads/match/');
defined('MATCH_FILE_SIZE')			OR define('MATCH_FILE_SIZE', 10240);
defined('LEVEL_PATH')				OR define('LEVEL_PATH', './../uploads/level/');
defined('LEVEL_SOURCE_PATH')		OR define('LEVEL_SOURCE_PATH', 'https://m9mbet.com/uploads/level/');
defined('LEVEL_FILE_SIZE')			OR define('LEVEL_FILE_SIZE', 10240);
defined('BLACKLIST_PATH')			OR define('BLACKLIST_PATH', './../uploads/blacklist/');
defined('BLACKLIST_SOURCE_PATH')	OR define('BLACKLIST_SOURCE_PATH', 'https://m9mbet.com/uploads/blacklist/');
defined('BLACKLIST_FILE_SIZE')		OR define('BLACKLIST_FILE_SIZE', 10240);
defined('BLOG_PATH')				OR define('BLOG_PATH', './../uploads/blog/');
defined('BLOG_SOURCE_PATH')			OR define('BLOG_SOURCE_PATH', 'https://m9mbet.com/uploads/blog/');
...
defined('BANKS_PLAYER_USER_BANK_SOURCE_PATH')	        OR define('BANKS_PLAYER_USER_BANK_SOURCE_PATH', 'https://m9mbet.com/uploads/userbank/');
...
defined('PLAYER_SITE_LANGUAGES')	OR define('PLAYER_SITE_LANGUAGES', json_encode(array(LANG_EN,LANG_ZH_CN,LANG_MS)));
...
defined('SYSTEM_API_AGENT_REFERRAL_LINK') OR define('SYSTEM_API_AGENT_REFERRAL_LINK', 'https://m9mbet.com/join/index/');
defined('SYSTEM_API_MEMBER_REFERRAL_LINK') OR define('SYSTEM_API_MEMBER_REFERRAL_LINK', 'https://m9mbet.com/join/index/');
defined('SYSTEM_API_MEMBER_SITE_LINK') OR define('SYSTEM_API_MEMBER_SITE_LINK', 'https://m9mbet.com');
...
defined('SYSTEM_DOMAIN_BANNED')		OR define('SYSTEM_DOMAIN_BANNED', json_encode(array("www","mail","api","bo","m9mbet","m9mbetbctbo","m9mbetpos8")));
defined('SYSTEM_API_MEMBER_DOMAIN_LINK') OR define('SYSTEM_API_MEMBER_DOMAIN_LINK', 'm9mbet.com');
defined('SYSTEM_ALL_DOMAIN') OR define('SYSTEM_ALL_DOMAIN', json_encode(array('m9mbet.com')));
defined('SYSTEM_DEFAULT_DOMAIN') OR define('SYSTEM_DEFAULT_DOMAIN', 'm9mbet.com');
...
defined('RANKING_CALCULATE_TYPE_EVERY_DAY_ONCE') OR define('RANKING_CALCULATE_TYPE_EVERY_DAY_ONCE', 1);
defined('RANKING_CALCULATE_TYPE_EVERY_WEEK_ONCE') OR define('RANKING_CALCULATE_TYPE_EVERY_WEEK_ONCE', 2);
defined('RANKING_CALCULATE_TYPE_EVERY_MONTH_ONCE') OR define('RANKING_CALCULATE_TYPE_EVERY_MONTH_ONCE', 3);
defined('SYSTEM_PAYMENT_GATEWAY_URL') OR define('SYSTEM_PAYMENT_GATEWAY_URL', 'https://m9mbet.com/gatewayapi/api/');

defined('SUBGAME_PATH')				OR define('SUBGAME_PATH', './../gameapi/assets/img/');
defined('SUBGAME_SOURCE_PATH')		OR define('SUBGAME_SOURCE_PATH', 'https://m9m.bctapi.com/assets/img/');
defined('SUBGAME_FILE_SIZE')		OR define('SUBGAME_FILE_SIZE', 10240);