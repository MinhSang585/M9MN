...
(function(MUI){
	function Datepicker(mui){
    	...
    	var dateTemplate = [
           	...
           	'				<div class="d-content-yesrmonth-last flaticon-play45"></div>',
           	'				<div class="d-content-yesrmonth-next flaticon-play45"></div>',
           	'			</div>',
           	'			<div class="d-content-week"></div>',
           	'			<div class="d-content-day"></div>',
           	'			<div class="">',
            '    		  	<div class="btn btn-mg btn-mgb submit">确认</div>',
            '    		  	<div class="btn btn-reset cancel">取消</div>',
           	'			</div>',
           	'		</div>',
    	...
    	function activeYear(){
    		...
    		for(var i = 0,l = divs.length;i<l;i++){
    			if(divs.eq(i).html()==that.activeDate.getFullYear() ){
    				...
    				window.$year = that.$yearWrap.find('.d-content-year');
