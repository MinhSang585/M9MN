...
class Console extends MY_Controller {
	...
	public function api_connect($provider_code = 'KX', $type = 'cm', $username = 'dgedev001',$game_id = 'GB8', $amount = '10', $game_type_code = 'SL', $game_code = "RT-SLOT-001", $is_demo = NULL) 
	{
	...
	public function logingame($provider_code = 'SA', $type = 'li', $username = 'lionking', $amount = '10', $game_type_code = 'LC', $game_code = NULL, $is_demo = NULL) 
	{
		$signature = md5(SYSTEM_API_AGENT_ID . $provider_code . $username . SYSTEM_API_SECRET_KEY);
